...
logits = tf.layers.dense(inputs=flat, units=4,kernel_regularizer=regularizer,name = 'logits')
...
x_train_ = np.load('sc1_group1_x.npy')
y_train_ = np.load('sc1_group1_y.npy')

x_test = np.load('sc1_1test_x.npy')
y_test = np.load('sc1_1test_y.npy')
