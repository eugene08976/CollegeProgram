...
logits = tf.layers.dense(inputs=flat, units=6,kernel_regularizer=regularizer,name = 'logits')
...
x_train_ = np.load('sc1_group2_x.npy')
y_train_ = np.load('sc1_group2_y.npy')

x_test = np.load('sc1_2test_x.npy')
y_test = np.load('sc1_2test_y.npy')
